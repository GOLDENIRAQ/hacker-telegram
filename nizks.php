<?php
//=========التوكن=========//
$token = "6513396178:AAHskSGNcoX2UA3saoC8qRB0P5r_LrS-jeg"; 
...
#############
$admin = "6730428261";
$Dev = array("$admin","6730428261");
$eri = array("$admin","6730428261");
$idbot = "6730428261";
$sudo = "$admin";
$buy = "THE_R5";
$DevUser = "@$buy";
...
file_put_contents("data/namebot.txt","كولدن");
...
$abuehab = array("هلا قلبي معاك كولدن","تفضل حبيبي انا كولدن🌝💞","يمك حياتي امرني 🥺💞","شتريد كل شويه كولدن","يابه نجب كل شويه كولدن خبصتنه");
$ehab = array_rand($proxre, 1);
if($text == "كولدن" and $namebot == NULL){
if ($tc == 'group' | $tc == 'supergroup'){
...
┃ ◈   𝙍𝘼𝙉𝙆 ︙ $info
┃ ◈   𝙀𝙉𝙏𝙄𝙏𝙄𝙀𝙎 ︙$new
┃ ◈   𝙈𝙀𝙎𝙎𝘼𝙂𝙀𝙎 ︙".$msgs['msgs'][$chat_id][$from_id].".
┃ ◈   𝙈𝙊𝙉𝙀𝙔 ︙"$game['game'][$chat_id][$from_id]."
",'reply_to_message_id'=>$message->message_id,
]));
}
}
...
if($text == "شلونك"){
if($settings["unlock"]["rdona"] == "مفتوح"){
bot('sendMessage',[
'chat_id'=>$chat_id, 
...
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"⋄︙اوامر الحمايه لسورس الكولدن
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
⋄︙قفل ، فتح ← الامر 
...
bot('sendmessage',[
'chat_id'=>$chat_id,
'text'=>"⋄︙اوامر الاعضاء لسورس الكولدن
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
...
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
⋄︙قناة البوت ← [@$devchink]";
$m6 = "⋄︙اوامر الاعضاء لسورس الكولدن
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
⋄︙تحويل/بالرد - لتحويل صيغ 
⋄︙ملصق ← صوره
⋄︙صوره ← ملصق
...
bot('sendMessage',[
'chat_id'=>$chat_id, 
'text'=>"⋄︙قائمة ملفات متجر سورس الكولدن
...
ᯓGold
 ...
 ⌯- لتنصيب سورس الكولدن الجديد v2.0.0 ⇓⇓⇓ 
...
⋄︙تغير الايدي ↫ تغ
ꔹ┉ ┉ ┉ ┉ ┉ ┉ ┉ꔹ
[Source Golden](https://t.me/THE_R5)",
'parse_mode'=>"markdown",'reply_to_message_id'=>$message_id,
 ]);
 } 
 #---------------#
